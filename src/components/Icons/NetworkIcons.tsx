...
export function Polygon({ width = "25", height = "25" }: Props) {
  return (
    <svg
...
export function BNB({ width = "25", height = "25" }: Props) {
  return (
    <svg
      width={width}
      height={height}
...
export function TUSD({ width = "25", height = "25" }: Props) {
  return (
    <svg
      width={width}
      height={height}
      ...
      <g id="Layer_x0020_1">
        <g id="_1942794901776">
          <path
            ...
            clipRule="evenodd"
            fill="#1B5AFE"
            d="M1250,0c690.4,0,1250,559.6,1250,1250s-559.6,1250-1250,1250    S0,1940.4,0,1250S559.6,0,1250,0z"
          ></path>
          <g>
            <path
              fillRule="evenodd"
...
export function BabyDoge({ width = "25", height = "25" }: Props) {
  return (
    <svg
      width={width}
      height={height}
	...
	.st34{fill:#DDDBDB;}`}
      ...
      <g>
        ...
        <path
          className="st8"
          d="M242.3,583.3c6.2,14.3,17.6,25.2,24.9,38.8c9.6,17.8,18.4,35.9,23.5,55.5c-5.2,3.7-6.9,8.9-6.9,15.1   c-0.1,6,1.2,12,0.1,18C255,677.9,220,650.9,194.4,615c-9.3-13.1-15.2-27.3-17.3-43.1c-0.3-2.3-2.3-5.8,2-7.1   c19.4,7.3,39.5,12,59.5,17.2C239.9,582.4,241.1,582.9,242.3,583.3z"
        />
        <path
          className="st8"
          d="M384.8,679.1c-0.1-1.4-3.2-0.9-1.2-4.3c4.5-7.6,6-16.6,9.6-24.8c8.3-18.7,17.5-36.8,30.6-52.7   c3.2-4,6.6-8.2,6.8-13.8c10.9-2.8,21.8-5.4,32.6-8.5c11.4-3.3,22.7-7.1,34-10.8c0.5,17.7-5.9,33.3-15.6,47.6   c-14.8,21.6-32.2,41.1-51.6,58.7c-14,12.7-28.4,25.1-38.2,41.6c-3.6-8.1-1.2-16.7-2-25C389.4,683.4,388.8,680.3,384.8,679.1z"
        />
        <path
          className="st10"
          d="M455.4,774.5c-1.4-5.2,2.3-8.7,4.5-12.4c22.5-37.8,40-77.7,51-120.2c6.6-25.5,8.2-51.7,1.9-77.8   c-0.5-2.1-0.3-5.1-3.6-5.6c1.6-1,3.2-2.2,4.9-3.1c17.2-8.8,14.1-11,22.5,7.9c10,22.5,8.8,46.1,4.6,69.9   c-5.8,32.5-19,62.3-32.4,92.1c-9.7,21.5-20.7,42.2-35.7,60.5c-3.5-0.2-5.1-3.7-8.2-4.7C461.6,779.2,457.5,778.2,455.4,774.5z"
        />
        <path
          className="st10"
          d="M164,558.3c-1.4,0.8-2.5,1.8-2.7,3.5c-1.8,16.9-5.5,33.5-3.1,51c3,22.2,6.7,44.2,15.6,64.9   c12.7,29.5,24.6,59.5,41.4,87c3.3,5.4,2.6,9.4-3,12.4c-5.7,5.4-11.4,2.6-17.1,0.1c-5-5.5-9-11.7-12.5-18.2   c-19.3-36.1-37.1-72.9-46.9-112.9c-6.2-25.2-9.2-50.6-0.6-76c1.8-5.4,4.3-10.4,6.7-15.6c2.2-4.9,5.2-6.6,10.1-3.5   C155.8,553.5,159.9,555.9,164,558.3z"
        />
        <path
          className="st10"
          d="M494.6,790.3c21.4-31.5,36.2-64.9,49.5-99c4-10.3,7.2-21,10.7-31.5c0.7-2,0.3-4.8,2.9-5.4   c2.9-0.7,4.9,1.2,6.7,3.3c10.6,12.1,15.8,26.5,16.8,42.3c1.6,24.2-6.1,46.4-16.3,67.8c-6.7,14-19.2,20.4-34.1,22.2   C519.1,791.4,507.4,790.5,494.6,790.3z"
        />
        <path
          className="st10"
          d="M177.7,790.3c-15,0-29.7,2-44.1-2.6c-10.9-3.5-19.6-9.9-24.5-20.2c-10-21.2-17.3-43.2-16.1-67.2   c0.7-14.9,5.8-28,14.6-39.8c1-1.4,2.3-2.7,3.6-3.8c5-4,6.6-3.6,8.3,2.5c10.3,36.9,26.2,71.4,44,105.2   C168,772.9,175.2,779.9,177.7,790.3z"
        />
        <path
          className="st11"
          d="M596.6,182c-14.9-22.6-30.9-44.2-50.5-63c-8.2-7.8-16.8-15.2-25.4-22.5c-2.3-2-2.9-3.3-0.8-5.8   c17.2-20.8,36.5-39,59.7-53c8.4,18.1,13.1,37.2,16.2,56.8c3.9,25.2,4.7,50.6,4.1,76C599.8,174.5,599.8,178.8,596.6,182z"
        />
        <path
          className="st11"
          d="M95.9,39c22.1,13.2,41.2,29.7,56.8,50.2c2.7,3.5,3.1,5.5-0.9,8.8c-23.7,19.9-44.6,42.7-63.8,66.9   c-2,0.4-2.6,2.5-4.2,3.4c-1,1.1-1.8,2.5-3,3.4c-2.4,1.7-4,1-4.8-1.8c-0.3-1.1-0.4-2.1-0.4-3.2c0.3-25.8-1.6-51.7,3.5-77.3   C82.6,71.9,87.2,54.7,95.9,39z"
        />
        <path
          className="st12"
        ...
        <path
          className="st10"
          d="M24.1,552c0.7-3,1.2-6,2.1-8.8c0.6-1.9,0.5-5,3.2-5c2.2,0,3.4,2.6,4.2,4.6c4.7,11.5,10.3,22.5,17.9,32.5   c15,19.8,34,34.7,56,46c2.6,1.4,5.5,2.1,5.6,6.2c0.1,4-1.6,5.7-4.7,7.5c-9,5.2-16,12.6-21.5,21.4c-1,1.6-1.2,3.9-3.6,4.3   c-8.5-2.5-14.5-8.7-20.5-14.5c-16-15.6-28-33.8-33.9-55.7c-2.3-11-5.3-21.9-5.1-33.3C23.7,555.4,24.4,553.7,24.1,552z"
        />
        <path
          className="st13"
          d="M95.9,39c0.8,1.9,1.1,3.6-0.1,5.5C86.3,60.3,83.3,78,80.1,95.8c-4.5,25.1-1.8,50.3-2.7,76   c3.9-0.8,5.1-4.5,8-5.7c0.7,0.8,0.8,1.6,0,2.4c-7.8,14.2-15.6,28.4-24,43.8c-2.9-7.4-3.5-13.8-4.1-20.1c-4-45.5-3.5-90.7,10-135   c2.4-7.7,5.7-15,9-22.4c2.3-5.1,5-5.7,9.5-2.8C89.2,34.3,92.9,36.1,95.9,39z"
        />
        <path
          className="st13"
          d="M596.6,182c3.7-44.9,0.7-89.1-13.9-132.1c-1.3-4-4.7-7.6-3.1-12.3c0.5-0.4,1-0.9,1.5-1.2   c13.4-8.6,14.2-8.5,20.4,6.5c9.3,22.5,14.2,46.1,16.2,70.3c1.7,20.4,2.7,40.8,1.2,61.3c-0.9,11.9-2.6,23.7-6.2,37.4   C606.8,201.1,601.7,191.6,596.6,182z"
        />
        <path
          className="st11"
          d="M305.2,560.4c0,1.5-0.2,3.1,0,4.6c0.6,4.4-1.3,5.5-5.5,5.5c-15.6,0.2-30.7-3.3-45.9-5.7   c-26.7-4.2-52.6-11.8-77.5-22.4c-4.8-2-9.4-4.6-13.9-7.1c-1.8-1-4.1-1.9-4-4.7c0.1-3-0.8-7.3,0.8-8.8c2.1-1.9,4.6,1.9,7,3.1   c4.4,2.4,8.9,4.5,14,5c3.9,0.4,7.8,1,11.4,2.4c18.6,7.2,38.2,10.2,57.7,13c16.1,2.3,32.4,3.5,48.7,4.2c6.4,0.3,7.7,2.7,7.1,8.1   C305,558.7,305.1,559.6,305.2,560.4C305.1,560.4,305.1,560.4,305.2,560.4z"
        />
        <path
          className="st10"
          d="M303.2,750.3c19.7,9,39.8,9.2,60.2,2.9c2.3-0.7,4.5-1.4,6.8-2.1c-0.4,12.1,3.3,24.2-0.9,36.3   c-0.8,2.1-0.8,3.3-3.1,3.3c-20,0-40,0-60,0c-2.8,0-3.9-1-3.8-3.9C302.7,774.6,303,762.4,303.2,750.3z"
        />
        <path
          className="st14"
          d="M328.3,644.7c-11.2-2.8-21.1-15.4-21.9-27.8c-0.8-12.9,7.7-25.3,20.1-29.7c12.9-4.5,26.8-0.9,34,8.9   c-0.8,5.1-1.5,10.2-1.5,15.5C358.9,627.8,344.2,643.4,328.3,644.7z"
        />
        <path
          className="st11"
          d="M454.2,540.3c17.2-3.8,34.2-8.4,50.7-14.6c1.4-0.5,2.9-1.1,4.4-1.3c2.5-0.4,6.2-3,7.3,0.6   c1.1,3.5,2.1,8.1-3.2,10.6c-23.7,11.1-48.2,20-73.8,25.5c-13.8,2.9-27.6,5.8-41.7,7c-6,0.8-11.8,3-17.9,2.9   c-4.2-0.1-9.1,0.5-11.3-4.4c-1.4-3.2,2.8-11,6.8-13.3c3.1-1.8,6.5-2.3,10-2.9c14.4-2.5,29-3,43.4-5.3   C437.2,543.6,445.7,542,454.2,540.3z"
        />
        <path
          className="st9"
          d="M30.6,591c9.1,29.6,27.6,52,52.7,69.5c-2.3,7.5-4.9,14.8-6.9,22.4c-1.1,4.1-2.4,4.2-5.6,1.9   c-28.7-21.5-45.9-49.8-50.9-85.4c-1.7-11.9-1.4-23.8,1.5-35.6c3.4,0.5,3.4,3.4,3.7,5.8c0.7,5.5,2.2,10.9,1.7,16.5   C26.5,588.7,27.7,590.7,30.6,591z"
        />
        <path
          className="st8"
          d="M455.4,774.5c3.5,1.8,7,3.6,10.4,5.4c-1.9,4.4-5.4,1.9-7.7,1.1c-5.1-1.7-8.5-0.5-11.8,3.8   c-4.7,6.2-10.8,11.2-16.6,16.9c3.1,2.3,7.7-0.2,10.9,4.8c-12.8-0.2-24.5,0.7-36.2-0.6c-9.4-3.9-13.6-11.6-12.9-23.8   c1.3-0.9-0.7-4.2,2.6-3.8c11.5-3.2,22.8-6.8,34.9-6.9C438,771.3,446.7,772.6,455.4,774.5z"
        />
        <path
          className="st8"
          d="M280.2,795.5c-2.3,5.3-5.6,9.4-11.7,10.5c-6.6,0.6-13.8,2.5-19.6-1.4c-9-6-17.3-13.2-22.5-23.1   c-2.3-4.3-0.7-6.1,4-7c15.5-3,30.1,0.7,44.6,5.4c7.8,2.5,8.2,3.6,6,11.9C280.7,793,281.1,794.4,280.2,795.5z"
        />
        <path
          className="st15"
          d="M280.2,795.5c0.6-11.9,0.6-11.9-11.8-16c-12.5-4.2-25.2-5.6-38.3-3.8c-3.6,0.5-4,2-2.5,4.7   c6.1,10.4,14.9,18.1,24.9,24.4c4.7,2.9,10.7,0.3,16.1,1.1c-31.8,4.2-50,2.6-66.7-19.9c-1.7-3.4,0.9-4.7,3.1-5.6   c2.3-0.9,4.6-2.1,7.2-2.2c19.6-7.9,39.3-8,59.3-1.5c3.9,1.3,8.1,1.7,12.1,2.5C283.7,784.9,283.1,790.4,280.2,795.5z"
        />
        <path
          className="st9"
          d="M404.5,805.8c11.3,0,22.6,0,33.9,0c-3.1-1.9-6.3-1-9.4-1.3c-1-0.1-2.3,0.2-2.8-1.1s0.5-2.1,1.3-2.7   c8-6.1,15-13.3,21.1-21.2c1.8-2.4,3.9-1.9,6.4-1.2c3.6,1,7,3.4,11.1,1.6c3.2,1.1,5.2,3.6,7.2,6c-11.8,14.9-26.8,22.9-46.2,21.5   C419.4,806.8,411.8,808.6,404.5,805.8z"
        />
        <path
          className="st16"
          d="M328.3,644.7c9.6-3.2,18.1-8.2,23.9-16.9c3.8-5.8,5.7-12,5.4-19c-0.2-4.3-1-9.2,3-12.6   c8.9,11.4,9.5,25.4,1.7,36.9C355,643.9,341.8,648.4,328.3,644.7z"
        />
        <path
          className="st17"
          d="M454.2,540.3c-11.3,5.6-23.7,6.2-35.9,7.8c-12.7,1.6-25.4,2.5-38,5c-7,1.4-8.7,6.3-10.4,11.8   c-1,3.3,1.7,3.1,3.3,3.5c5.8,1.2,11.7,0.9,17.5,0.1c2.4-0.3,4.7-0.9,7.1-0.5c-8.6,2.5-16.8,6.8-26.4,3.9c-5.3-1.6-6.9-4.7-6.1-9.7   c0-0.2,0.1-0.4,0.1-0.6c2-12.9,3-14.4,16.5-14.6c20.6-0.3,41-2.9,61.2-6.5C446.7,539.9,450.5,540.3,454.2,540.3z"
        />
        <path
          className="st18"
          d="M336.8,565.7c-0.4,0-0.9,0-1.3,0c-10.4,0.3-10.2,0.3-10-10c0.1-4.2,1-6.5,5.8-6c3.4,0.4,6.9,0,10.4,0.1   c5.7,0.1,8.3,2.1,7.8,8.7c-0.4,5.6-1.2,8.6-7.6,7.3C340.4,565.4,338.6,565.7,336.8,565.7z"
        />
        <path
          className="st19"
          d="M30.6,591c-0.3,1.3-0.5,2.7-2.4,1.4c-2.2-1.5-3.9-2.8-3.4-6.2c1.1-7.7-0.2-15.3-3.5-22.4   c-0.7-2.8,0.5-5.4,1.3-8c0.8-0.7,1.6-0.7,2.2,0.2C25.8,567.9,28.3,579.4,30.6,591z"
        />
        <path
          className="st20"
          d="M212.2,778.3c-3.1,3-9.2,2-10.3,7.7c-2.9-2.5-5-5.6-6.8-8.8c5.7-0.1,11.5,2.8,17.1-0.1   C212.2,777.4,212.2,777.9,212.2,778.3z"
        />
        <path
          className="st21"
          d="M391.5,749.6c-0.1,1.5,0.2,3.1-1.4,4.1c0.7-12.4-1.1-24.8,1.1-37.2c0.2,0.2,0.4,0.5,0.5,0.8   C392,728.1,392.5,738.9,391.5,749.6z"
        />
        <path
          className="st22"
          d="M390.2,757.2c2.8,5.1,0,10.9,2.1,16c-0.8,1.2,0.3,2.8-1.1,3.8C388.6,770.6,389.7,763.9,390.2,757.2z"
        />
        <path
          className="st23"
          d="M391.3,777.1c0.4-1.3-0.2-2.8,1.1-3.8c0.6,1.7,1.2,3.3,1.7,5c-0.9,1.3-1.7,2.6-2.6,3.8   C391.4,780.4,391.4,778.7,391.3,777.1z"
        />
        <path
          className="st24"
          d="M115.6,23.4c-1.5,0.4-3.3-0.2-4.3,1.6c-1.2-0.6-2.4-1.1-3.6-1.7c1.1-2.9,3.1-1.6,5-1.1   C113.8,22.6,114.7,23,115.6,23.4z"
        />
        <path
          className="st25"
          d="M112.8,22.2c-1.7,0.4-3.7-0.8-5,1.1c-1-0.6-3.7-1-0.8-2.3C108.6,20.2,111.1,20.6,112.8,22.2z"
        />
        <path
          className="st26"
          d="M24.9,556c-0.7-0.1-1.5-0.1-2.2-0.2c-0.4-1.6,0.8-2.6,1.4-3.9C25.2,553.2,25.3,554.6,24.9,556z"
        />
        <path
          className="st27"
          d="M85.3,168.5c0-0.8,0-1.6,0-2.4c0.6-1,0.9-2.9,2.7-1.2C87.3,166.3,87,168,85.3,168.5z"
        />
        <path
          className="st28"
          d="M565.3,23.6c-0.5-1.2-1.7-1.1-2.7-1.4c1.4-1.3,3.2-1.9,4.5-0.6C567.8,22.3,566.5,23.3,565.3,23.6z"
        />
        <path
          className="st0"
          d="M494.9,303.8c-10.3-0.4-18.6-0.8-26.5-3.5c-23.1-7.6-30.9-27.1-19.5-48.7c9.9-18.8,32.6-27.4,53.2-20.1   c20.1,7.2,31.8,27.3,27.9,48.2c-2.4,12.8-10.6,20.9-24.1,23.2C501.6,303.6,497.3,303.6,494.9,303.8z"
        />
        <path
          className="st0"
          d="M179.8,303.6c-4-0.1-8.8,0.3-13.5-0.9c-17.4-4.3-25.3-18.6-21.7-39.5c3.8-22.2,26.6-37.9,49-33.9   c23.9,4.2,39.4,25.2,35.7,48.2c-1.4,8.7-6.8,14.3-14.1,18.6C206.1,301.4,196.2,303.6,179.8,303.6z"
        />
        <path
          className="st8"
          d="M224.3,155.6c19-2,33.4,22,25.2,40.7c-2,4.7-5.8,7.7-10.4,9.4c-13.2,4.9-26.4,5.1-39.1-1.8   c-13-7-16.1-21.7-6.8-33.2C201.1,161,211.2,155,224.3,155.6z"
        />
        <path
          className="st8"
          d="M451.8,209.3c-2.9-0.3-5.5-0.5-8.1-0.9c-23-3.8-25.5-23.5-17.2-39.2c9.2-17.4,29.8-16.8,44.8-7.3   c2,1.3,3.8,2.9,5.5,4.6c6.5,6.5,11.9,13.8,8.6,23.7c-3.2,9.7-10.8,15-20.4,17.4C460.7,208.7,456,208.8,451.8,209.3z"
        />
        <path
          className="st0"
          d="M286.8,317.7c-0.4-13.7,4.8-22.3,17.5-27.6c21-8.8,42.4-9.1,63.6-0.8c9,3.5,17.2,8.7,19.3,19.5   c1.8,6.8,0.6,13.3-2,19.5c-5.8,13.7-16.2,22.8-29.4,29.1c-1.5,0.7-3.4,0.8-4.4,2.6c2,3.5,7,3.6,8.6,7.5c16.7,10.7,28,8.8,40.2-6.6   c3.9-5,7-10.5,10-16.1c2.9-5.3,7.3-5.9,12.2-3.5c4.5,2.3,6.9,5.5,4.5,11.1c-6,14.4-14.3,27-28.1,34.9c-4.5,2.6-6.5,6-7.5,11.2   c-3.6,19.3-11.4,36.6-27.2,49.2c-17.2,13.8-39.4,13.4-56.3-0.9c-15.8-13.4-23.2-31.2-27-50.9c-0.8-4-2.5-6.4-5.9-8.6   c-12.8-8.3-21.8-19.8-27.4-34c-2.3-6-0.6-10.1,4.6-12.3c5.9-2.5,9.5-1.1,12.5,4.9c2.6,5.3,5.6,10.3,9.3,15   c12.1,15.3,23.6,17.2,40.2,6.5c1.6-3.9,6.3-4.4,9-7.9c-6.3-3.2-12.5-6.2-17.9-10.5c-6.4-5.1-11.6-11.1-15.2-18.4   C288,326.6,286.8,322.4,286.8,317.7z"
        />
        <path
          className="st15"
          d="M360,367.6c-4.5-2.1-8.6-4.7-12.8-8.2c23.3-9.4,39.7-23.7,40-50.6c7.1,16.5,0.9,38.3-13.5,49.4   C369.3,361.6,363.7,363.2,360,367.6z"
        />
        <path
          className="st29"
          d="M286.8,317.7c5.3,21.3,19.8,33.9,40.2,41.5c-4.2,3.7-8.4,6.2-12.8,8.4c-4.5-3.3-8.8-6.7-13.4-9.8   c-9.1-6.2-13.7-15.3-16.3-25.5C283.2,327.3,285.8,322.6,286.8,317.7z"
        />
        <path
          className="st30"
          d="M391.5,749.6c0.1-10.8,0.2-21.6,0.3-32.3C393.2,728.1,393.5,738.9,391.5,749.6z"
        />
        <path
          className="st31"
          d="M495.1,256.5c0.1,7.6-5.5,14.1-12.4,14.3c-8.4,0.2-14.3-5.4-14.5-14c-0.2-7.3,6.1-13.8,13.6-14.1   C488.1,242.5,494.9,249.6,495.1,256.5z"
        />
        <path
          className="st31"
          d="M205.7,257.1c0,8.5-5.1,13.3-13.8,13.3c-8.2-0.1-12.7-5-12.6-14c0-7.3,5.5-13.1,12.5-13.2   C200,243,205.7,248.6,205.7,257.1z"
        />
        <path
          className="st32"
          d="M337.4,320.7c-8.1-1.2-16.5-0.9-24-5.2c-3.6-2-6.9-4.7-6.8-8.9c0.1-4.4,3.5-7.4,7.5-9   c15.2-5.9,30.4-5.8,45.6,0c3.9,1.5,7.5,4,8,8.6c0.4,5-3.6,7.1-7.1,9.2C353.5,319.8,345.4,319.9,337.4,320.7z"
        />
        <path
          className="st33"
          d="M361.4,421.5c-0.7,1.1-1.4,2.2-2.2,3.2c-16.2,19.2-32.1,18.4-47.2-2.1c1.1-2.4,3.4-3.3,5.7-4   c14.1-4.1,28-2.9,41.8,1.3C360.3,420.1,360.9,420.8,361.4,421.5z"
        />
        <path
          className="st34"
          d="M361.4,421.5c-13.7-2.8-27.5-5.6-41.5-1.7c-2.7,0.8-5.3,1.8-7.9,2.7c-4.6-6-4.6-6.1,2.4-8.3   c14.9-4.7,29.8-4.7,44.9-0.3C364.7,415.6,365.6,417.6,361.4,421.5z"
        />
      </g>
    </svg>
  );
...
export function LINK({ width = "25", height = "25" }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
